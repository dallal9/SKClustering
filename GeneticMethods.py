...
class meanshift:
    ...
    def generate_pop(self, size=1):
        ...
        for i in range(size):
            ...
            population.append(["meanshift",
                               MeanShift(cluster_all=cluster_all, bin_seeding=bin_seeding, bandwidth=bandwidth,
                                         max_iter=max_iter)])
        return population
    ...
    def generate_pop(size=1):
        ...
        for i in range(size):
            ...
            population.append(["affinity_propagation",
                               AffinityPropagation(damping=damping, max_iter=max_iter)])
        return population
...
class SpectralCluster:
    ...
    def generate_pop(size=1):
        ...
        for i in range(size):
            ...
            eigen_solver = random.choice([None, 'arpack', 'lobpcg'])  # removed 'amg' for now
...
class AgglomerativeCluster:
    ...
    def generate_pop(size=1):
        ...
        for i in range(size):
            ...
            if linkage == 'ward':  # Ward can only work with euclidean distances.
                affinity = 'euclidean'
            else:
